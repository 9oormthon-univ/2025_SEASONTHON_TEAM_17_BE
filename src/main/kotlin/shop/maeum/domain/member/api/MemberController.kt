...
class MemberController(
    ...
    @PatchMapping("/mypage")
    override fun changeNickname(@RequestBody changeNicknameReqDto: ChangeNicknameReqDto): RspTemplate<ChangeNicknameResDto> {
        return RspTemplate(
            httpStatus = HttpStatus.OK,
            message = "닉네임 변경 성공",
            memberService.changeNickname(changeNicknameReqDto)
        )
    }
}